...
public abstract class RecycledPagerAdapter<VH extends RecycledPagerAdapter.ViewHolder> extends PagerAdapter {
    ...
    ArrayMap<Integer, VH> destroyedItems = new ArrayMap();

    @Override
    public final Object instantiateItem(ViewGroup container, int position) {
        VH viewHolder = destroyedItems.get(position);
        ...
        if (viewHolder != null) {
            ...
            viewHolder = onCreateViewHolder(container, getItemViewType(position));
            onBindViewHolder(viewHolder, position);
            container.addView(viewHolder.itemView);
        }
    ...
    public final void destroyItem(ViewGroup container, int position, Object object) {
        ...
        destroyedItems.put(position, (VH) object);
    }
