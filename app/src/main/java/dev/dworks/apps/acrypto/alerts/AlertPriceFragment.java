...
public class AlertPriceFragment extends RecyclerFragment
    ...
    private static final String TAG = "AlertsPrice";
    private Utils.OnFragmentInteractionListener mListener;
    private AlertPriceAdapter mAdapter;
    private FloatingActionButton addAlert;

    public static void show(FragmentManager fm) {
        final Bundle args = new Bundle();
        final FragmentTransaction ft = fm.beginTransaction();
        final AlertPriceFragment fragment = new AlertPriceFragment();
        fragment.setArguments(args);
        ft.replace(R.id.container, fragment, TAG);
        ft.commitAllowingStateLoss();
    }

    public static AlertPriceFragment get(FragmentManager fm) {
        return (AlertPriceFragment) fm.findFragmentByTag(TAG);
    }
    ...
    public static AlertPriceFragment newInstance() {
        AlertPriceFragment fragment = new AlertPriceFragment();
        Bundle args = new Bundle();
        fragment.setArguments(args);
        return fragment;
    }

    public AlertPriceFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_alert_price, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (null == mAdapter) {
            mAdapter = new AlertPriceAdapter(getActivity(), getQuery(), this, this);
        }
    ...
    private void openAlertDetails(AlertPrice alertPrice, String refKey) {
        Intent intent = new Intent(getActivity(), AlertDetailActivity.class);
        Bundle bundle = new Bundle();
        bundle.putSerializable(BUNDLE_ALERT, alertPrice);
        bundle.putString(BUNDLE_REF_KEY, refKey);
        bundle.putInt(BUNDLE_ALERT_TYPE, 1);
