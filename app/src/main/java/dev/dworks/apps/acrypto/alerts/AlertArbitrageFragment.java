...
public class AlertArbitrageFragment extends RecyclerFragment
    ...
    private static final String TAG = "AlertsArbitrage";
    private Utils.OnFragmentInteractionListener mListener;
    private AlertArbitrageAdapter mAdapter;
    private FloatingActionButton addAlert;

    public static void show(FragmentManager fm) {
        final Bundle args = new Bundle();
        final FragmentTransaction ft = fm.beginTransaction();
        final AlertArbitrageFragment fragment = new AlertArbitrageFragment();
        fragment.setArguments(args);
        ft.replace(R.id.container, fragment, TAG);
        ft.commitAllowingStateLoss();
    }

    public static AlertArbitrageFragment get(FragmentManager fm) {
        return (AlertArbitrageFragment) fm.findFragmentByTag(TAG);
    }
    ...
    public static AlertArbitrageFragment newInstance() {
        AlertArbitrageFragment fragment = new AlertArbitrageFragment();
        Bundle args = new Bundle();
        fragment.setArguments(args);
        return fragment;
    }

    public AlertArbitrageFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_alert_arbitrage, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (null == mAdapter) {
            mAdapter = new AlertArbitrageAdapter(getActivity(), getQuery(), this, this);
        }
    ...
    public Query getQuery() {
        return FirebaseHelper.getFirebaseDatabaseReference().child("/user_alerts/arbitrage")
    ...
    private void openAlertDetails(AlertArbitrage alertArbitrage, String refKey) {
        Intent intent = new Intent(getActivity(), AlertDetailActivity.class);
        Bundle bundle = new Bundle();
        bundle.putSerializable(BUNDLE_ALERT, alertArbitrage);
        bundle.putString(BUNDLE_REF_KEY, refKey);
        bundle.putInt(BUNDLE_ALERT_TYPE, 2);
